...

{
  ...
  pdfViewer.addEventListener("load", async () => {
    ...
    const pdfViewerHTML = `<body id="builtin-pdf-viewer"><style>${styleString}</style><iframe src="${pdfObjectURL}"></iframe><a class="mdc-fab" href="${pdfObjectURL}" target="_blank"></a></body>`
